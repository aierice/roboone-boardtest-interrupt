...
//	USART_ClearITPendingBit(USART3,USART_IT_RXNE);		//0502í«â¡
...
/*	//Configure DMA for usart1
	...
	// Configure TX DMA
	DMA_InitStructure.DMA_BufferSize = 1;		//ÇŸÇÒÇ‹Ç©ÅH
...
//2bitÇÃéÛêMÇëOíÒÇ∆ÇµÇΩÉRÉìÉgÉçÅ[ÉâÅDïsóvÇ»ã@î\Ç¡Ç€Ç¢
//	void USART3_IRQHandler( void){
//
//		uint16_t command = 0;
//		static uint16_t inpcommandfull;
